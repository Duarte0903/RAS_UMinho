...
def message_queue_setup(channel):
    ...
    channel.queue_declare(queue="resize-requests")
    channel.queue_bind(
        ...
        while True:
            for file_name in os.listdir(PICTURAS_SRC_FOLDER):
                ...
                resize_parameters = {
                    ...
                    "resizeWidth": 300,  # Example width, can be randomized or passed as a parameter
                    "resizeHeight": 200  # Example height, can also be randomized
                }

                publish_request_message(channel, "requests.resize", request_id, "resize", resize_parameters)
